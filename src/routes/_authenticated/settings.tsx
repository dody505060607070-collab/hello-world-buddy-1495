...
export const Route = createFileRoute("/_authenticated/settings")({
  head: () => ({
    meta: [
      { title: "إعدادات الموقع — الرشودي للعقارات العقارية" },
      { name: "description", content: "التحكم في بيانات الموقع والتواصل وإعدادات التشغيل." },
      { property: "og:title", content: "إعدادات الموقع — الرشودي للعقارات العقارية" },
...
function SettingsPage() {
  ...
  useEffect(() => {
    if (data) setForm(data);
      ...
      setForm({
        id: true,
        company_name: "الرشودي للعقارات العقارية",
        logo_url: null,
        phone: null,
  ...
  const save = useMutation({
    mutationFn: async () => {
      ...
      const payload = {
        id: true,
        company_name: form.company_name?.trim() || "الرشودي للعقارات العقارية",
